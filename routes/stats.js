...
// ==================== POST method to create a new player
const createStats = async (req, res, next) => {
  ...
  router
    ...
    // ===================== for updating a player’s stats with a PUT method
    ...
    //   ==================== create a DELETE method to remove the player’s stats
